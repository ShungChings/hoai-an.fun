...
<img alt='profile card' src='./image/hoaian.png'/>
</div>
<div class='profile-card__cnt js-profile-cnt'>
<div class='profile-card__name'>Phan Hoài Ân <i class='fa fa-check-circle' style='color:rgb(17, 143, 249)' title='Verified Author'></i>
</div>
<div class='profile-card__txt'>Tôi là <b>Phan Hoài Ân <b style='color:blue;'>(ShungChingg)</b></b>,Một coder nghiệp dư mong muốn trở thành Developer FullStack , Kiến thức còn kém mong các anh, chị chỉ bảo,... <i></i> ...</div>
<div class='profile-card-loc'>
<span class='profile-card-loc__icon'>
<svg class='icon'><use xlink:href='#icon-location'></use></svg>
</span>
<span class='profile-card-loc__txt'>Đức Huệ - Long An</span>
</div>
...
<a class='profile-card-social__item facebook' href='https://www.facebook.com/HoaiAnShungChing/' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-facebook'></use></svg>
</span>
</a>
<a class='profile-card-social__item link' href='https://hoaian.fun/' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-link'></use></svg>
</span>
</a>
<a class='profile-card-social__item twitter' href='https://twitter.com/' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-twitter'/></svg>
</span>
</a>
<a class='profile-card-social__item instagram' href='https://www.instagram.com/HoaiAnShungChing/' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-instagram'/></svg>
</span>
</a>
<a class='profile-card-social__item tik tok' href='https://www.tiktok.com/@shungchingg?_t=8aaCGls0uF0&_r=1' target='_blank'>
<span class='icon-font'>
...
<button class='profile-card__button button--orange' onclick='window.open(&#39;https://www.facebook.com/HoaiAnShungChing;)'>Follow</button>
</div>
</div>
...
<button class='profile-card__button button--blue js-message-close'>Gửi</button>
<button class='profile-card__button button--gray js-message-close'>Trở Lại</button>
</div>
</form>
