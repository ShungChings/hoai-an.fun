...
<img alt='profile card' src='./image/trinhle.png'/>
</div>
<div class='profile-card__cnt js-profile-cnt'>
<div class='profile-card__name'>Lê Hà Phương Trinh<i class='fa fa-check-circle' style='color:rgb(17, 143, 249)' title='Verified Author'></i>
</div>
<div class='profile-card__txt'>Tôi là <b>Lê Hà Phương Trinh <b style='color:blue;'>(Trinh_Art/Wibu)</b></b>,Một họa sĩ nghiệp dư , mê truyên tranh , không thích reply tin nhắn người lạ , mê gái alime , Wibu số 1 VietNamese.... <i></i> ...</div>
...
<a class='profile-card-social__item facebook' href='https://www.facebook.com/profile.php?id=100084047044385' target='_blank'>
...
<a class='profile-card-social__item instagram' href='#chuaco' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-instagram'/></svg>
</span>
</a>
<a class='profile-card-social__item tik tok' href='#chuaco' target='_blank'>
<span class='icon-font'>
...
<button class='profile-card__button button--orange' onclick='window.open(&#39;https://www.facebook.com/profile.php?id=100084047044385;)'>Follow</button>
</div>
</div>
